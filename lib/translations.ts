  ...
  'en-US': {
    ...
    settings: {
      ...
      logoUpload: {
        ...
        lightModeLogo: 'Logo (Light Mode)',
        lightModeDescription: 'This logo will be used in light mode. In dark mode, it will be inverted if no dark mode logo is provided.',
        darkModeLogo: 'Logo (Dark Mode)',
        darkModeDescription: 'Optional. If provided, this logo will be used in dark mode without inversion. If not provided, the light mode logo will be inverted in dark mode.',
        currentDarkLogo: 'Current Dark Mode Logo',
        notSet: 'Not set',
        uploadDarkLogo: 'Upload Dark Logo',
        changeDarkLogo: 'Change Dark Logo',
        removeDarkLogo: 'Remove',
        darkSuccess: 'Dark mode logo uploaded successfully',
        darkError: 'Failed to upload dark logo',
        darkRemoved: 'Dark mode logo removed successfully',
        darkRemoveError: 'Failed to remove dark logo',
        darkModeNote: 'Note: The default logo will never be inverted, even in dark mode.',
      },
      renameOrganization: {
    ...
    datadog: {
      ...
      api: {
        rateLimit: {
          ...
          waitingForReset: 'Waiting for rate limit to reset',
          waitingTime: 'Estimated wait time: {seconds} seconds',
        },
      },
      observability: {
        costGuard: {
      ...
      costGuard: {
        ...
        summary: {
          ...
          captions: {
            acrossFamilies: 'Across product families',
            projectedTrend: 'Projection based on 30-day trend',
            averageUtilization: 'Average utilization vs commitment',
            estimatedTime: 'Estimated time to reach 100%',
          },
          runwayDays: 'days',
          runwayNa: 'N/A',
        },
        ...
        contractEdit: {
          ...
          clearing: 'Clearing...',
          clearAll: 'Clear All',
          clearConfirm: 'Are you sure you want to clear all contract data? This action cannot be undone.',
          success: 'Contract saved successfully! Updating...',
          importPdf: 'Import Quote PDF',
          errors: {
            load: 'Failed to load contract',
            save: 'Failed to save contract',
            clear: 'Failed to clear contract',
            import: 'Failed to import quote',
        ...
        table: {
          ...
          statusColumn: 'Status',
          aggregationTypeColumn: 'Aggregation',
        ...
        progress: {
          ...
          loadingCount: 'Loading {completed} of {total} services...',
        },
        errors: {
        ...
        api: {
          timeout: {
            ...
            message: 'The request took too long to complete. This can happen when fetching data from many services. Please try again.',
          },
          rateLimit: {
            title: 'Rate Limit Exceeded',
            message: 'The Datadog API is temporarily rate limiting requests. Please wait a moment and try again.',
            retrying: 'Retrying automatically in {seconds} seconds...',
            waiting: 'Waiting for rate limit to reset. Please wait...',
            waitingForReset: 'Aguardando reset do rate limit',
            waitingTime: 'Tempo estimado de espera: {seconds} segundos',
          },
        },
      },
    },
  ...
  'pt-BR': {
    ...
    settings: {
      ...
      logoUpload: {
        ...
        lightModeLogo: 'Logotipo (Modo Claro)',
        lightModeDescription: 'Este logotipo será usado no modo claro. No modo escuro, será invertido se nenhum logotipo para modo escuro for fornecido.',
        darkModeLogo: 'Logotipo (Modo Escuro)',
        darkModeDescription: 'Opcional. Se fornecido, este logotipo será usado no modo escuro sem inversão. Se não fornecido, o logotipo do modo claro será invertido no modo escuro.',
        currentDarkLogo: 'Logotipo Atual do Modo Escuro',
        notSet: 'Não definido',
        uploadDarkLogo: 'Enviar Logotipo do Modo Escuro',
        changeDarkLogo: 'Alterar Logotipo do Modo Escuro',
        removeDarkLogo: 'Remover',
        darkSuccess: 'Logotipo do modo escuro enviado com sucesso',
        darkError: 'Falha ao enviar logotipo do modo escuro',
        darkRemoved: 'Logotipo do modo escuro removido com sucesso',
        darkRemoveError: 'Falha ao remover logotipo do modo escuro',
        darkModeNote: 'Nota: O logotipo padrão nunca será invertido, mesmo no modo escuro.',
      },
      renameOrganization: {
    ...
    datadog: {
      ...
      costGuard: {
        ...
        table: {
          ...
          statusColumn: 'Status',
          aggregationTypeColumn: 'Agregação',

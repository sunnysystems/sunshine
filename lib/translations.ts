  ...
  'en-US': {
    ...
    datadog: {
      credentials: {
        ...
        removeDialogDescription: 'This removes the Datadog API and application keys from Supabase Vault for this organization.',
  ...
  'pt-BR': {
    ...
    datadog: {
      credentials: {
        ...
        removeDialogDescription: 'Isso remove as chaves Datadog do Supabase Vault para esta organização.',
    ...
    datadog: {
      ...
      apiCredentials: {
        ...
        description:
          'As credenciais são criptografadas e armazenadas com segurança no Supabase Vault. Apenas proprietários e administradores podem gerenciar essas credenciais.',
        apiKeyLabel: 'API Key',
        apiKeyPlaceholder: 'dd_api_key_xxx',
        appKeyLabel: 'Application Key',
        appKeyPlaceholder: 'dd_app_key_xxx',

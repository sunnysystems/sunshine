  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: LineChart,
        roles: ['owner', 'admin', 'member'],
        featureKey: 'datadogBusinessObservability',
      },
      {
        ...
        icon: GitBranch,
        roles: ['owner', 'admin', 'member'],
        featureKey: 'datadogCorrelationStories',
      },
      {
        ...
        icon: Gauge,
        roles: ['owner', 'admin', 'member'],
        featureKey: 'datadogObservabilityMaturity',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Cpu,
        roles: ['owner', 'admin'],
        featureKey: 'datadogPerformanceRemediation',
      },
      {
        ...
        icon: Bug,
        roles: ['owner', 'admin'],
        featureKey: 'datadogErrorAutofix',
      },
      {
        ...
        icon: Lightbulb,
        roles: ['owner', 'admin'],
        featureKey: 'datadogCostInsights',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: MessageSquare,
        roles: ['owner', 'admin'],
        featureKey: 'datadogCommunications',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: TrendingUp,
        roles: ['owner', 'admin', 'member'],
        featureKey: 'datadogFinopsForecast',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: LayoutDashboard,
        roles: ['owner', 'admin'],
        featureKey: 'datadogCostGuardContract',
      },
      {
        ...
        icon: LineChart,
        roles: ['owner', 'admin'],
        featureKey: 'datadogCostGuardMetrics',
      },
      {
        ...
        icon: Sparkles,
        roles: ['owner', 'admin'],
        featureKey: 'datadogCostGuardActions',
      },
    ],
  },
];
